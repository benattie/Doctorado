...
title('H_{Gaussian} Pole Figure (x100)  (contours)');
...
title('H_{Lorentzian} Pole Figure (x100) (contours)');
...
title('Domain size Pole Figure (nm) (contours)');
...
title('Microstrain Pole Figure (contours)');
savefigure(fname);
colorbar;
title('Microstrain Pole Figure (contours)');
