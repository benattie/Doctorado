    ...
    def __init__(self, files, rings, cmwp_results):
        ...
        for omega in range(rings.omega_i, rings.omega_f, rings.delta_omega):
            ...
            for pattern in range(rings.pattern_i, rings.pattern_f + 1, rings.delta_pattern):
                ...
                fp_sol.write("%4d %8.4f %8.4f %8.4f %8.4f %8.4f %8.4f " % (k + 1, 2 * rings.theta, rings.theta, omega, pattern, alpha, beta))
                ...
                fp_fitvar.write("%8d %8.4f %8.4f %8.4f %8.4f %8.4f %8.4f " % (k + 1, 2 * rings.theta, rings.theta, omega, pattern, alpha, beta))
