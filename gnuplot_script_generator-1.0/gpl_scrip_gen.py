...
for i in range(0,36):
    ...
    f.write('plot \'' + data + '\' i ' + str(i) + ' u 1:5:6 w error pt 5 ps 1.5, \'rst_py.dat\' i ' + str(i) + ' u 1:5:6 w error pt 13 ps 1.5\n')
    f.write('pause -1\n')
    f.write('set terminal png enhanced\nset output \'comp_FWHM_dif' + '{:0>3}'.format(str(10*i)) + '.png\'\n')
    f.write('replot\nset terminal wxt\nset output\n')

    #ETA
    f.write('set ylabel \'ETA\'\n')
    f.write('plot \'' + data + '\' i ' + str(i) + ' u 1:7:8 w error pt 9 ps 1.5, \'rst_py.dat\' i ' + str(i) + ' u 1:7:8 w error pt 11 ps 1.5\n')
    f.write('pause -1\n')
